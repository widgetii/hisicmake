...
/*
SAMPLE_COMM_VI_GetMipiLaneMode

Hi3516EV200 Hi3518EV300 : return 0
Hi3516EV300             : return 1
InValid Chip            : return -1
*/
HI_S32 SAMPLE_COMM_VI_GetMipiLaneMode(HI_VOID)
{
    HI_S32  s32Ret    = HI_SUCCESS;
    HI_U32  u32ChipId = 0;
    ...
    {
        SAMPLE_PRT("not support this chip\n");
        return -1;
    }

    if (u32ChipId == HI3516E_V200 || u32ChipId == HI3518E_V300)
    {
        SAMPLE_PRT("support this chip %x\n", u32ChipId);
        return 0;
    }
...
/*
* Function name:SAMPLE_COMM_VI_GetComboAttrBySns
...
HI_S32  SAMPLE_COMM_VI_SwitchMode_StopVI(SAMPLE_VI_CONFIG_S *pstViConfigSrc)
{
    ...
    // SAMPLE_COMM_VI_StopIsp(pstViConfigSrc);
...
HI_S32  SAMPLE_COMM_VI_SwitchMode(SAMPLE_VI_CONFIG_S *pstViConfigDes)
{
    ...
    //SAMPLE_COMM_VI_StartIsp(pstViConfigDes);
    if (s32Ret != HI_SUCCESS)
    {
...
char *SAMPLE_COMM_VI_CompressMode2String(COMPRESS_MODE_E enCompressMode)
{
    ...
    else if (COMPRESS_MODE_NONE == enCompressMode)
    {
        return "CMP_LINE";
    }
